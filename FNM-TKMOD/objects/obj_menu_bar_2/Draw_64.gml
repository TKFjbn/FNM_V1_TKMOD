...
for (var i = 0; i < sprite_get_number(sprite_index);i++) {
	...
	if (point_in_rectangle(mouse_x,mouse_y,1830,90 * i,1920,89 + 90*i)) {
	...
	draw_rectangle(1830 * _escala_draw ,90* i * _escala_draw,1920 * _escala_draw,(89 + 90*i) * _escala_draw,0);
	//dibujar el icono
	draw_sprite_ext(sprite_index,i,1830 * _escala_draw ,90 * i * _escala_draw,_escala_draw,_escala_draw,0,c_white,1);
